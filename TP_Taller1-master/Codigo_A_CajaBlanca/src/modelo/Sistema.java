...
public class Sistema {
	...
	/**
	 * <b>Post: </b> Se obtiene una instancia de Sistema
	...
	/**
	 * <b>Pre: </b> El par�metro persona debe ser distinto de null y de cadena vac�a, la persona debe existir 
	 * <b>Post: </b> Devuelve la factura con el precio total
	...
	public String listarFactura(String persona) {
		...
		assert persona != null : "La persona debe ser distinto de null";
		assert !persona.equals("") : "La persona debe ser distinto de cadena vac�a";
		assert listaFacturas.get(persona) != null : "La persona debe existir en la listaFacturas";
	...
	/**
	 * <b>Post: </b> Devuelve toda la informaci�n detallada de las facturas
